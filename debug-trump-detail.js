    ...
    for (const slug of slugs) {
        try {
            ...
            for (let i = 0; i < tokenIds.length; i++) {
                ...
                const spreads = [0.01, 0.02, 0.05];

                spreads.forEach(spread => {
                    // Use Absolute Spread (e.g. 0.01 = 1 cent)
                    // Anchor around Mid Price (or Best Bid/Ask?)
                    // Let's use Mid Price for absolute spread as it's symmetric
                    ...
                    console.log(`    Spread ${spread * 100}% (Anchor: Bid ${bestBid}, Ask ${bestAsk}):`);
